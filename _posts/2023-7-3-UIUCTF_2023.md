...
Qua giải này mình đã có cơ hội được tìm hiểu về namespace, thứ công nghệ mà chúng ta thường hay sử dụng thông qua Docker. Cũng từ giải này mình rút ra được vài kinh nghiệm 
